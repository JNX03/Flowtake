...
const COMMAND_MAP = {
    ...
    // Session-only live credential. The stream key has no renderer-readable getter.
    'set-live-stream-key': 'set_live_stream_key',
    'has-live-stream-key': 'has_live_stream_key',
    // Projects
    ...
    'resolve-project-media': 'resolve_project_media',
...
const ARGS_MAP = {
    ...
    'set_live_stream_key': (args) => ({ rtmpUrl: args[0], streamKey: args[1] }),
    ...
    'init_recording': (args) => ({ source: args[0], cameraMicConfig: args[1], systemAudio: args[2], mode: args[3] ?? null }),
    ...
    'process_audio': (args) => ({ renderId: args[0], audioPlan: args[1] }),
    ...
    // Manual updater action intentionally accepts no renderer-controlled URL.
    'install_update': () => ({}),
