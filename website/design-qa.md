...
- The site is configured for the release-gated v1.7.2 page and checksum link instead of implying that a concept frame is recorded product footage. Pages must remain blocked until that exact release exists.
