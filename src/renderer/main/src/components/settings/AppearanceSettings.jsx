...
const THEMES = [
    {
        id: "flowtake-dark",
        name: "Flowtake Dark",
        colors: { primary: "#6C5CE7", accent: "#00CEC9", bg: "#1a1a2e" }
    },
    {
        id: "tokyo-night",
        name: "Tokyo Night",
        colors: { primary: "#7aa2f7", accent: "#9ece6a", bg: "#1a1b26" }
    },
    {
        id: "dracula",
        name: "Dracula",
        colors: { primary: "#bd93f9", accent: "#50fa7b", bg: "#282a36" }
    },
    {
        id: "nord-dark",
        name: "Nord",
        colors: { primary: "#88c0d0", accent: "#a3be8c", bg: "#2e3440" }
    },
    {
        id: "catppuccin-mocha",
        name: "Catppuccin Mocha",
        colors: { primary: "#cba6f7", accent: "#a6e3a1", bg: "#1e1e2e" }
    },
    {
        id: "gruvbox-dark",
        name: "Gruvbox Dark",
        colors: { primary: "#fabd2f", accent: "#b8bb26", bg: "#282828" }
    },
    {
        id: "solarized-dark",
        name: "Solarized Dark",
        colors: { primary: "#268bd2", accent: "#2aa198", bg: "#002b36" }
    },
    {
        id: "rose-pine",
        name: "Rose Pine",
        colors: { primary: "#c4a7e7", accent: "#9ccfd8", bg: "#191724" }
    },
    {
        id: "synthwave-84",
        name: "Synthwave '84",
        colors: { primary: "#f97e72", accent: "#36f9f6", bg: "#2b213a" }
    },
    {
        id: "one-dark",
        name: "One Dark",
        colors: { primary: "#61afef", accent: "#98c379", bg: "#282c34" }
    },
    {
        id: "midnight",
        name: "Midnight",
        colors: { primary: "#82aaff", accent: "#c3e88d", bg: "#0F111A" }
    }
]
